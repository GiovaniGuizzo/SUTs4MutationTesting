...
public class FindTest {
    ...
    public void testTS_1_136() {
        ...
        int arg1 = 3;
        Find obtained = new Find(arg1);
        assertTrue(obtained.mF == 0);
    }
    ...
    public void testTS_1_138() {
        ...
        int arg1 = 3;
        Find obtained = new Find(arg1);        
        assertTrue(obtained.A.length == 3);
    }
    ...
    public void testTS_1_143() {
        ...
        obtained.addItem(5);
        obtained.addItem(4);
        obtained.partition(2);
        assertTrue(obtained.mF == 2);
    }
